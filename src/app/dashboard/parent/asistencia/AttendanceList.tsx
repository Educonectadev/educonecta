                  ...
                  <tbody className="divide-y divide-gray-50 md:divide-y-0">
                    {records.map((r) => (
                      <tr
                        ...
                        className="flex flex-col md:table-row border border-gray-100 md:border-0 rounded-[30px] p-4 md:p-0 mb-3 md:mb-0 cursor-pointer hover:bg-gray-50/50 transition-colors"
                      >
