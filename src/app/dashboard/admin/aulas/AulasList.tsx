  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
        ...
        <button onClick={() => { setShowCreate(true); resetForm() }} className="rounded-[30px] bg-black dark:bg-white px-6 py-2.5 text-sm font-medium text-white dark:text-black transition-all hover:bg-gray-800 dark:hover:bg-zinc-200 text-center">+ Registrar Aula</button>
      </div>
      ...
      <Modal open={showCreate} onClose={() => setShowCreate(false)} title="Registrar Aula" size="md" scroll="inside">
        ...
        <div className="flex gap-3 mt-8">
          ...
          <button onClick={handleCreate} disabled={loading || !form.name} className="flex-1 rounded-[30px] bg-black dark:bg-white text-white dark:text-black py-2.5 text-sm font-medium hover:bg-gray-800 dark:hover:bg-zinc-200 transition-all disabled:opacity-50">
